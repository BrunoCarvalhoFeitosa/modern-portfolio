...
export const MacbookScroll = ({ showGradient, title, badge }: {
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[100dvh] lg:min-h-[80dvh] xl:min-h-[200dvh] flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.h4
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-zinc-100 dark:bg-[#010101] rounded-2xl p-2"
      >
        <div className="absolute top-0 left-0 w-full h-full bg-zinc-100 dark:bg-[#111]">
            <div className="p-3">
                ...
                <div className="mt-5 text-black dark:text-white">
                    <p className="mb-4 xl:text-[14px] font-light">
                        Formado em Análise e Desenvolvimento de Sistemas,
                        iniciei minha carreira como desenvolvedor front-end
                        em uma consultoria. Lá trabalhei por mais de 4 anos
                        em muitos projetos, cada um com uma proposta, desafios 
                        e tecnologias diferentes que me fizeram aprender e evoluir.
                    </p>
                    <p className="xl:text-[14px] font-light">
                        Nesta consultoria, me especializei no desenvolvimento de 
                        lojas VTEX, trabalhei para grandes marcas como Avon, 
                        L&apos;oreal, Suvinil, The North Face, Toy Mania, Orthocrin, 
                        Superget, Trousseau, Zinzane, Malwee, Mob Online, Segredos de Salão,
                        Skinceuticals, Loja 99 e Loungerie.
                    </p>
                </div>
            </div>
        </div>
